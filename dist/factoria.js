...
var _this = this;
var definitions = {};
var isDictionary = function (thingy) {
    return Object.prototype.toString.call(thingy) === '[object Object]';
};
var appliedStates = [];
...
var generate = function (name, overrides, states) {
    ...
    states.forEach(function (state) {
        if (!Object.prototype.hasOwnProperty.call(definitions[name].states, state)) {
            throw new Error("Model \"".concat(name, "\" has no \"").concat(state, "\" state."));
        }
        var stateDescriptor = definitions[name].states[state];
        stateAttributes = cjs(stateAttributes, stateDescriptor instanceof Function
            ? stateDescriptor.call(_this, faker__default["default"])
            : stateDescriptor);
    });
    var result = cjs.all([
...
var factory = function (name, count, overrides) {
    ...
    if (!Object.prototype.hasOwnProperty.call(definitions, name)) {
        throw new Error("Model \"".concat(name, "\" not found."));
    }
    ...
    var generated = count === 1
        ...
        : Array.from(Array(count)).map(function () {
            return generate(name, overrides, appliedStates);
        });
